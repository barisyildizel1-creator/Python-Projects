...
app = Flask(__name__)
# Use SECRET_KEY from environment variables (.env file or deployment platform)
# For security, no fallback key is provided - must be set in environment
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY')
if not app.config['SECRET_KEY']:
    raise ValueError("SECRET_KEY environment variable must be set! Check your .env file or deployment configuration.")
...
# Make gravatar_url available in templates
